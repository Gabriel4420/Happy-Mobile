...
export default function OrphanageDetails() {
  ...
  const location = `${orphanage?.latitude},${orphanage?.longitude}`
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <RectButton
          ...
          onPress={() =>
            Linking.openURL(
              `whatsapp://send?text=Gostaria%20de%20saber%20como%20ajudar%20${orphanage.name}?&phone=${orphanage.whatsapp}`
            )
          }
        >
